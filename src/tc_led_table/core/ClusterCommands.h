 ...
 * 5. In LedTableApi.ccp add appropriate pass-through methods if the command is
 *    accessible to the api user. Perhaps some ClusterCommands are internal to
 *    The Api?
 * 6. Add case to executeMessageCommand in ClusterMessage.cpp
 * 7. register types in Message serialize/desirialize
 ***/
